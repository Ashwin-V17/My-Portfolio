...
const Portfolio = () => {
    ...
    // Mobile Apps - Featured Projects
  {
    ...
    links: [
      { 
        type: "customer",
        playStore: "https://play.google.com/store", // Customer app Play Store link
        appStore: "https://apps.apple.com/", // Customer app App Store link
        label: "Customer App"
      },
      { 
        type: "vendor",
        playStore: "https://play.google.com/store", // Vendor app Play Store link
        appStore: "https://apps.apple.com/", // Vendor app App Store link
        label: "Vendor App"
      }
    ],
    featured: true,
