      ...
      <div className="about-content flex-1 max-w-[700px] z-10 animate-fadeInRight">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8 animate-fadeInUp animation-delay-400">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <p className="text-[1.2rem] text-gray-400 max-md:text-[1rem]">
                {stat.label}
              </p>
            </div>
          ))}
        ...
        <div className="animate-fadeInUp animation-delay-500 mb-8">
          <p className="text-[1.6rem] leading-relaxed text-gray-300 mb-4 max-md:text-[1.4rem]">
            Full Stack and Mobile Application Developer with{" "}
            <span className="text-accent font-semibold">
              1+ year of hands-on experience
            </span>{" "}
            in building cross-platform applications using{" "}
          ...
          <p className="text-[1.6rem] leading-relaxed text-gray-300 max-md:text-[1.4rem]">
            Skilled in backend API development, authentication, and database
        ...
        <div className="mb-8 animate-fadeInUp animation-delay-600">
          <h4 className="text-[1.8rem] font-semibold mb-4 text-gray-300">
            My Interests
          </h4>
          <div className="flex gap-4 flex-wrap">
            {interests.map((interest, index) => (
              ...
              >
                <span
                  className={`absolute inset-0 bg-gradient-to-r ${interest.color} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                ></span>
                <span className="relative flex items-center gap-2 text-[1.4rem] font-medium max-md:text-[1.2rem]">
                  <i
                    className={`fas ${interest.icon} text-accent group-hover:scale-125 transition-transform duration-300`}
                  ></i>
                  {interest.name}
                </span>
              </div>
        ...
        <div className="flex gap-4 flex-wrap items-center">
          ...
          >
            ...
            <span className="relative z-10 flex items-center gap-2">
              ...
              <i
                className={`fa-solid fa-arrow-${isExpanded ? "up" : "down"} group-hover:translate-y-1 transition-transform duration-300`}
              ></i>
            </span>
          </button>
