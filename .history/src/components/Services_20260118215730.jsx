...
const Services = () => {
  ...
  return (
    <section className="relative min-h-screen pt-[2rem] pr-[9%] pb-8 pl-[9%] max-md:pt-[10rem] max-md:px-[3%] max-md:pb-28 overflow-hidden" id="services">
      {/* Animated Background */}
      ...
      {/* Section Header */}
      <div className="text-center mb-10 max-md:mb-12 relative z-10">
        <div className=" animate-fadeInUp">
          <span className="text-[1.4rem] text-accent font-semibold tracking-wider uppercase opacity-80">
            What I Offer
          </span>
        </div>
        <h2 className="text-[4.5rem] font-bold mb-2 max-md:text-[3.5rem] animate-fadeInUp animation-delay-200">
