...
const Portfolio = () => {
    ...
    // Mobile Apps - Featured Projects
  {
    ...
    category: "mobile",
    description: "Comprehensive construction materials marketplace with professional hiring and land buying features. Dual platform supporting complete construction ecosystem with separate customer and vendor applications.",
    technologies: ["React Native", "Java", "PHP", "MySQL", "Firebase", "Razorpay"],
    links: [
       { 
        type: "customer",
        playStore: "https://play.google.com/store/apps/details?id=com.construvtions.veeconstructions", // Customer app
        appStore: "https://apps.apple.com/in/app/vee-builds/id6754379231",
        label: "Customer App"
      },
      { 
        type: "vendor",
        playStore: "https://play.google.com/store/apps/details?id=com.construvtions.veeconstructions.vendor", // Vendor app
        appStore: "https://apps.apple.com/in/app/veebuild-business/id6753942254",
        label: "Vendor App"
      }
    ],
    featured: true,
  ...
  },
  {
    ...
    category: "mobile",
    description: "Doctor, lab, and pharmacy booking platform with real-time chat functionality and secure JWT authentication. Separate apps for customers and healthcare service vendors with order processing system.",
    technologies: ["React Native", "Expo", "Laravel Lumen", "MySQL", "JWT", "Firebase"],
    links: [
      { 
        type: "customer",
        playStore: "https://play.google.com/store/apps/details?id=com.app.meduora", // Customer app
        appStore: "https://apps.apple.com/in/app/meduora/id6753971605",
        label: "Customer App"
      },
      { 
        type: "vendor",
        playStore: "https://play.google.com/store/apps/details?id=com.app.meduorahealthhcare", // Vendor app
  ...
  },
    {
      ...
      title: "Accsys India",
      category: "mobile",
      description: "E-commerce platform with integrated network marketing features enabling product sales and distributor management. Successfully integrated payment gateway and multi-level marketing features.",
    ...
    },
    {
      ...
      category: "mobile",
      description: "Innovative banana leaf selling app with three distinct user roles: customers, hotels, and catering services. Seamless ordering experience with integrated payment processing.",
    ...
    // Web Projects
    {
      ...
      category: "web",
      description: "Educational platform connecting students with tutors, featuring course management, video streaming, and comprehensive learning tools.",
    ...
    },
    {
      ...
      category: "web",
      description: "Comprehensive CRUD application for managing student records with authentication, role-based access, and efficient data management using MERN stack.",
    ...
    },
    {
      ...
      category: "web",
      description: "Admin dashboard for managing products, orders, and analytics with real-time data visualization and comprehensive reporting features.",
    ...
    },
    {
      ...
      category: "web",
      description: "Modern portfolio website with smooth animations, responsive design, and interactive UI elements showcasing projects and skills.",
  ...
  const filters = [
    ...
    { id: 'mobile', label: 'Mobile Apps', icon: 'fa-mobile-screen-button', count: 4 },
    ...
    <section className="relative min-h-screen pt-[10rem] pr-[9%] pb-8 pl-[9%] bg-bg-secondary max-md:pt-[10rem] max-md:px-[3%] max-md:pb-28 overflow-hidden" id="portfolio">
      ...
      <div className="text-center mb-12 max-md:mb-8 relative z-10">
        ...
        <p className="text-[1.6rem] text-gray-400 max-w-[700px] mx-auto mb-8 animate-fadeInUp animation-delay-300 max-md:text-[1.4rem]">
          Building production-ready applications from healthcare to construction, with 8+ apps live on Play Store & App Store
        </p>
          ...
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="flex items-center gap-2 justify-center mb-2">
                <i className={`fa-solid ${stat.icon} text-accent text-[2rem]`}></i>
                <span className="text-[3rem] font-bold text-accent max-md:text-[2.5rem]">{stat.number}</span>
              </div>
              <p className="text-[1.4rem] text-gray-400 max-md:text-[1.2rem]">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
        ...
        {filters.map((filter) => (
          ...
          >
            ...
            <span className="relative z-10 flex items-center gap-2">
              ...
              {filter.label}
              {filter.count && (
                <span className={`ml-1 px-2 py-0.5 rounded-full text-[1.2rem] ${
                  activeFilter === filter.id 
                    ? 'bg-white/20' 
...
{project.isDualPlatform && (
  <div className="absolute top-16 right-4 z-20 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full text-[1.2rem] font-semibold flex items-center gap-2 shadow-lg">
    ...
    project.links.map((link, linkIndex) => (
      <div key={linkIndex} className="space-y-2">
        <p className="text-[1.3rem] text-gray-400 font-semibold flex items-center gap-2">
          <i className={`fa-solid ${link.type === 'customer' ? 'fa-user' : 'fa-store'}`}></i>
          {link.label}
        </p>
