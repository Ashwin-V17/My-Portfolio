...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "mobile",
      description:
        "E-commerce platform which provides a seamless shopping experience for customers and efficient order management for vendors. The app features secure payment integration, real-time order tracking, and a user-friendly interface.",
