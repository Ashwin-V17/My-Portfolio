...
const Portfolio = () => {
  ...
  const projects = [
    ...
    {
      image: "https://veebuilds.com/assets/images/vee-logo.png", // Replace with actual screenshot
      title: "Vee Build & Vee Build Business",
      category: "mobile",
      description: "Comprehensive construction materials marketplace with professional hiring and land buying features. Dual platform supporting complete construction ecosystem with user and vendor apps.",
      technologies: ["React Native", "Java", "PHP", "MySQL", "Firebase", "Razorpay"],
      link: "https://play.google.com/store", // Add actual link
      appStore: "https://apps.apple.com/", // Add actual link
      github: null,
      featured: true,
    ...
    },
    {
      ...
      title: "Meduora & Meduora Vendor",
      category: "mobile",
      description: "Doctor, lab, and pharmacy booking platform with real-time chat functionality and secure JWT authentication. Vendor management system for processing orders and managing healthcare services.",
